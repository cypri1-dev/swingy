...
public class GuiEscapePage extends GuiCustomPage {

	public static void showEscapePage(JComponent panel, Map<String, ImageIcon> listToken, Icon icon, JPanel grid, JPanel baseInventory, Game rpg) {
		
		GuiCustomPage.setShowingPageEscape(true);

		panel.removeAll();
		panel.setLayout(new BorderLayout());

		Icon escapeIcon = listToken.get("elementaire_air");
		if (escapeIcon == null)
			escapeIcon = new ImageIcon();

		JLabel potionLabel = new JLabel("<html><div align='center'>With lightning reflexes, you escape into the shadows!\"</div></html>");
		...
		JLabel iconLabel = new JLabel(escapeIcon);
